...
# B) Attack the val plateau (~1.0): weighted_mse + lambda_smooth=0.1
...
echo "[INFO] Starting Round 3 mmtc sweep in $(pwd)"

echo
echo "============================================================"
echo "[RUN A] mmtc | concat/mean | huber | huber_delta 1.0"
echo "============================================================"
...
echo
echo "============================================================"
echo "[RUN B] mmtc | concat/mean | huber | huber_delta 0.5"
echo "============================================================"
python train.py "${BASE_ARGS[@]}" \
  --loss_type huber \
  --huber_delta 0.5 \
...
echo
echo "============================================================"
echo "[RUN C] mmtc | mean/mean | huber | huber_delta 1.0"
echo "============================================================"
python train.py "${BASE_ARGS[@]}" \
  --loss_type huber \
  --gat_head_merge mean \
...
echo
echo "[INFO] Round 3 mmtc completed."
